...
import 'package:providerapp_gobuddy/screens/registrationFeePage.dart';
import 'package:providerapp_gobuddy/utilites/appcolor.dart';
import 'package:providerapp_gobuddy/utilites/custombackbutton.dart';
                ...
                child: ElevatedButton(
                    onPressed: isFormValid()
                      ...
                      Future.delayed(Duration(seconds: 2), () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => RegistrationFeePage()),
                        );
                      });
                    }

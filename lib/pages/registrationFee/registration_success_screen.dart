              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: screenHeight * 0.025),
                    Text(
                      "నమోదు చేసినందుకు ధన్యవాదాలు! మీ సమాచారం ధృవీకరించిన తరువాత మేము వీలైనంత త్వరగా మిమ్మల్ని సంప్రదిస్తాము. అంతలో, ఏవైనా సందేహాలు ఉంటే దయచేసి 9177746889 కి ఫోన్ చేసి సంప్రదించండి.",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: screenWidth * 0.035,
                        color: Colors.black87,
